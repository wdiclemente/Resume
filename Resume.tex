...
%\makeatletter
%\def\@tablebox#1{\begin{tabular}[t]{@{}c@{}}#1\end{tabular}} % center the lines in address
%\makeatother

\begin{document} 

\name{\scshape{William K. DiClemente, PhD}\\[12pt]} % the \\[12pt] adds a blank line

\address{will.diclemente@gmail.com\\(414) 617-2645}
\address{\tt{linkedin.com/in/will-diclemente}\\ \hspace{47.7pt}\tt{github.com/wdiclemente}}
%\address{will.diclemente@gmail.com\\(414) 617-2645\\ \tt{linkedin.com/in/will-diclemente}\\ \tt{github.com/wdiclemente}}
...
\section{TECHNICAL SKILLS}
    ...
    {\bf Experienced in} Unix-based OS, \LaTeX, SQL, Bash, Git, Java %, Matlab, Fortran
