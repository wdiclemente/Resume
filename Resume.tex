...
\section{RESEARCH EXPERIENCE}%\vspace{-10pt}
    ...
    \begin{itemize}
    \item Modified existing method for modeling background contribution from fake leptons to achieve better data-simulation agreement
    \item Developed new method using 2D cuts to reduce 3-lepton backgrounds, tests showed up to 20\% additional background rejection
    \end{itemize}
